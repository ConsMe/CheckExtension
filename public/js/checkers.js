...
new Vue({
  ...
  mounted: function mounted() {
    ...
    $(this.$refs.stopConfirmation).on('hidden.bs.modal', function (e) {
      _this.stopCheckerId = null;
    });
  ...
  computed: {
    ...
    stopCheckerName: function stopCheckerName() {
      var _this3 = this;

      if (this.stopCheckerId) {
        return this.checkers.filter(function (checker) {
          return checker.id == _this3.stopCheckerId;
        })[0].name;
      }
    ...
    changePasswordName: function changePasswordName() {
      ...
      if (this.changePasswordId) {
        return this.checkers.filter(function (checker) {
          return checker.id == _this4.changePasswordId;
        })[0].name;
      }
  ...
  methods: {
    changeErrorsCount: function changeErrorsCount(parameter) {
      var _this5 = this;

      this.disabled[parameter] = true;
      var id = this.changePasswordId;
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/checkers/change-errors-count", {
        parameter: parameter,
        ...
        _this5.disabled[parameter] = false;
      });
    },
    ...
    addChecker: function addChecker() {
      ...
      var name = this.name;
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/register/checker", {
        name: name,
    ...
    deleteChecker: function deleteChecker() {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/checkers/delete", {
        id: id
      }).then(function (response) {
        toastr.success("\u0427\u0435\u043A\u0435\u0440 ".concat(name, " \u0443\u0434\u0430\u043B\u0435\u043D"));
        _this7.checkers = response.data;
      })["catch"](function (error) {
        toastr.warning('Что-то пошло не так, попробуйте позднее');
      })["finally"](function () {
        _this7.disabled["delete"] = false;
      });
    },
    confirmStopChecker: function confirmStopChecker(id) {
      this.stopCheckerId = id;
      $(this.$refs.stopConfirmation).modal('show');
    },
    stopChecker: function stopChecker() {
      var _this8 = this;

      if (!this.stopCheckerId) return;
      this.disabled.stop = true;
      var id = this.stopCheckerId;
      $(this.$refs.stopConfirmation).modal('hide');
      var name = this.checkers.filter(function (checker) {
        return checker.id == id;
      })[0].name;
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/checkers/stop", {
        id: id
      }).then(function (response) {
        toastr.success("\u0427\u0435\u043A\u0435\u0440 ".concat(name, " \u043E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D"));
        _this8.checkers = response.data;
      })["catch"](function (error) {
        toastr.warning('Что-то пошло не так, попробуйте позднее');
      })["finally"](function () {
        _this8.disabled.stop = false;
      });
    },
    showChangeWindow: function showChangeWindow(checker) {
    ...
    changePassword: function changePassword() {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/users/changepassword", {
        id: id,
        password: password
      }).then(function (response) {
        toastr.success("\u041F\u0430\u0440\u043E\u043B\u044C \u0447\u0435\u043A\u0435\u0440\u0430 ".concat(name, " \u0438\u0437\u043C\u0435\u043D\u0435\u043D")); // $(this.$refs.changeData).modal('hide')
      })["catch"](function (error) {
        if (error.response.data.errors) {
          toastr.warning(Object.entries(error.response.data.errors)[0][1][0]);
          return;
        ...
        _this9.disabled.changepassword = false;
      });
      ;
    }
  }
