...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addChecker: function addChecker(id, name) {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/admins/addchecker", {
        checker_id: id,
    ...
    removeChecker: function removeChecker(id, name) {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/admins/removechecker", {
        checker_id: id,
        admin_id: this.admin.id
      }).then(function (response) {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("p", { staticClass: "text-center text-secondary" }, [
      _c("small", [
        _vm._v("Админ будет автоматически разлогинен здесь и в телеграме")
      ])
    ])
  },
  function() {
...
new Vue({
  ...
  methods: {
    ...
    addadmin: function addadmin() {
      ...
      var name = this.name;
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/register/admin", {
        name: name,
    ...
    deleteAdmin: function deleteAdmin() {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/admins/delete", {
        id: id
      }).then(function (response) {
