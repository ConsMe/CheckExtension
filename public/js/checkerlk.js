...
new Vue({
  ...
  mounted: function mounted() {
    ...
    $(this.$refs.exitConfirm).on('hidden.bs.modal', function (e) {
      _this.disabled.exit = false;
    });
    $(this.$refs.exitButton).removeAttr('onclick').click(function (e) {
      e.originalEvent.preventDefault();
      e.originalEvent.stopPropagation();
      $(_this.$refs.exitConfirm).modal('show');
    });
  },
  methods: {
    add: function add() {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post('/checker/add', {
        ...
        _this2.checkers = r.data;
        _this2.url = '';
        _this2.search = '';
        _this2.interval = 5;
        chrome.runtime.sendMessage(_this2.extensionId, {
          refreshCheckers: true,
          checkers: _this2.checkers
        });
    ...
    stopstart: function stopstart(checker) {
      var _this3 = this;
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post('/checker/stopstart', {
        ...
        var status = isworking ? 'запущен' : 'остановлен';
        toastr.success("\u0427\u0435\u043A\u0435\u0440 ".concat(status));
        _this3.checkers = r.data;
        chrome.runtime.sendMessage(_this3.extensionId, {
          refreshCheckers: true,
          checkers: _this3.checkers
        });
      })["catch"](function (error) {
    ...
    confirmDelete: function confirmDelete(checker) {
    ...
    deleteChecker: function deleteChecker() {
      ...
      _Http__WEBPACK_IMPORTED_MODULE_0__["default"].post("/checker/delete", {
        ...
        chrome.runtime.sendMessage(_this4.extensionId, {
          refreshCheckers: true,
          checkers: _this4.checkers
        });
      })["catch"](function (error) {
        toastr.warning('Что-то пошло не так, попробуйте позднее');
      })["finally"](function () {
        _this4.disabled["delete"] = false;
      });
    },
    checkSettedUp: function checkSettedUp() {
      var _this5 = this;
      ...
      chrome.runtime.sendMessage(this.extensionId, {
        ...
        if (response.version != _this5.extensionVersion) {
          _this5.warningVersion = true;
          return;
        }
      });
    },
...
/***/ 2:
/*!*****************************************!*\
  !*** multi ./resources/js/checkerlk.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/alex/Documents/FL/CheckExtension/CheckExtension/resources/js/checkerlk.js */"./resources/js/checkerlk.js");
